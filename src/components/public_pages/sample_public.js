    ...
    <div className="themaindiv">
      <div className="row no-gutters">
        ...
        <div className="col-sm-2 col-md-2 firstboxes">
          ...
          <div className="pl-3 h6 text-white mt-5"><i className="fas fa-user-alt text-white text-bold"></i> Profile</div>
          <div className="pl-3 h6 text-white mt-5"><i className="fa fa-building text-white text-bold"></i> Jobs</div>
          <div className="pl-3 h6 text-white mt-5"><i className="fas fa-user-alt text-white text-bold"></i> Experience</div>
          <div className="pl-3 h6 text-white mt-5"><i className="fas fa-user-alt text-white text-bold"></i> Personal Information</div>
          <div className="pl-3 h6 text-white mt-5"><i className="fa fa-gear text-white text-bold"></i> Settings</div>
          <div className="pl-3 h6 text-white mt-5"><i className="fa fa-sign-out text-white text-bold"></i> Logout</div>
            ...
            <div className="container-fluid"><button className="btn btn-link d-md-none rounded-circle mr-3" type="button"><i className="fas fa-bars"></i></button>
                ...
                <ul className="nav navbar-nav flex-nowrap ml-auto">
                    ...
                    <li className="nav-item dropdown no-arrow mr-3" role="presentation">
                        <div className="nav-item dropdown no-arrow"><span className="d-none d-lg-inline mr-2 text-gray-600 small">Abhijit Patil</span><img className="border rounded-circle img-profile" src={avatar1} alt="imagea" height="30px" width="30px"/>
            </div>
            </li>
            </ul>
          </div>
